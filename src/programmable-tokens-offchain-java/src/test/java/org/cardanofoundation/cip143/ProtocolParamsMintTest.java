...
import org.cardanofoundation.cip143.contract.AbstractContract;
...
@Slf4j
public class ProtocolParamsMintTest {
    ...
    private final Account adminAccount = Account.createFromMnemonic(network, PreviewConstants.ADMIN_MNEMONIC);

    private final BFBackendService bfBackendService = new BFBackendService(BLOCKFROST_PREVIEW_URL, BLOCKFROST_KEY);
